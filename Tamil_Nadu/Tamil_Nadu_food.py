# -*- coding: utf-8 -*-
"""
Created on Sat Feb 10 18:26:47 2018
...
for i in range(0,len(s)):
    ...
    for j in range(len(corpus_food)):
        if corpus_food[j] in wr_br:
            ...
            final_list_food1.append(statement)
            break 
...
df_final=pd.DataFrame({'Review':actual_statement_food,'Rating':y_pred},columns=['Review','Rating'])
